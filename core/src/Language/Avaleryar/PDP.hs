...
submitAssertion :: Text -> [Rule TextVar] -> [Fact] -> PDP ()
...
unsafeSubmitAssertion :: Text -> [Rule TextVar] -> PDP ()
...
pdpConfigRules :: NativeDb -> [Rule TextVar] -> Either PDPError PDPConfig
